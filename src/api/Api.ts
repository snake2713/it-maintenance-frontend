...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  services = {
     ...
     *
     * @tags services
     * @name ServicesImageList
     * @request GET:/services/{service_id}/image/
     * @secure
     */
    servicesImageList: (serviceId: string, params: RequestParams = {}) =>
      this.request<void, any>({
     ...
     *
     * @tags services
     * @name ServicesUpdateVideoCreate
     * @request POST:/services/{service_id}/update_video/
     * @secure
     */
    servicesUpdateVideoCreate: (
      serviceId: string,
      data: {
        /** @format binary */
        video?: File;
      ...
      this.request<void, any>({
        path: `/services/${serviceId}/update_video/`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.FormData,
     ...
     *
     * @tags services
     * @name ServicesVideoList
     * @request GET:/services/{service_id}/video/
     * @secure
     */
    servicesVideoList: (serviceId: string, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/services/${serviceId}/video/`,
        method: "GET",
        secure: true,
        ...params,
      }),
